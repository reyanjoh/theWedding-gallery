...
const BlogSectionOtherTopic = () => {
  return (
    <section className='scroll-area BlogSectionOtherTopic'>
        <div className='BlogSectionOtherTopic-content-container'>
          <div className='BlogSectionOtherTopic-large-content-container'>
          ...
          <div className='BlogSectionOtherTopic-small-content-container BlogSection-small-content'>
              <a href="http://" target="_blank" rel="noopener noreferrer">
              ...
              <a className='BlogSectionOtherTopic-view-more not-available' href="/blogs/all-blogs" rel="noopener noreferrer">
